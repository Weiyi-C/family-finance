<template>
  <div>
    ...
    <el-card class="filter-card">
      <el-form :inline="true" :model="filters">
        ...
        <el-form-item label="关键词">
          <el-input v-model="filters.keyword" placeholder="搜索备注/商户" clearable style="width: 160px;" />
        </el-form-item>
        <el-form-item>
    ...
    <el-dialog v-model="showCreateDialog" :title="editingId ? '编辑交易' : '记一笔'" width="520px" destroy-on-close>
      <el-form :model="form" label-width="80px">
        ...
        <el-form-item label="账户">
          <el-select v-model="form.payment_account_id" clearable placeholder="选择账户" style="width: 100%;">
...
import type { Transaction, Category, PaymentAccount } from '@/types'
...
const filters = reactive({ type: '', keyword: '', start_date: '', end_date: '' })
...
async function loadTransactions() {
  ...
  try {
    ...
    total.value = res.data.length // backend doesn't return total yet
  } catch {
