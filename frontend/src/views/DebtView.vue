  ...
  <div>
    ...
    <el-card>
      <el-table :data="debts" stripe v-loading="loading">
        <el-table-column prop="counterparty" label="对方" width="100" />
        ...
        <el-table-column label="已还" align="right"><template #default="{ row }">{{ formatMoney(row.repaid_amount) }}</template></el-table-column>
        ...
        <el-table-column prop="debt_date" label="日期" width="110" />
